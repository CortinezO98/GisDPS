                            ...
                            <form name="buscar_cita" action="" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <?php if ($tipo=='cancelar'): ?>
                                        ...
                                        <?php elseif(isset($_POST["buscar_cita"]) AND $control_cancelar>0 AND $captcha_response): ?>
                                            <div class="card text-center">
                                              <div class="card-body">
                                                <p class="card-text">Lo sentimos, se ha excedido el tiempo para cancelación de la cita. Para agendar una nueva cita deberá esperar el cumplimiento de la primera fecha programada.</p>
                                                <div class="form-group">
