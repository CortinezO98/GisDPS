...
// ini_set('display_errors', '1');
    ...
    if ($tipo=='cancelar-confirma' AND $id_cita!="") {
        if(isset($_POST["cancelar_cita"])){
            ...
            $consulta_actualizar_reserva = $enlace_db->prepare("UPDATE `gestion_citas_agenda_reservas` SET `gcar_cancela_fecha`=?, `gcar_estado`=? WHERE `gcar_consecutivo`=?");
            ...
            if (comprobarSentencia($enlace_db->info)) {
                ...
                if (comprobarSentencia($enlace_db->info)) {
                    ...
                    $contenido="<p>Buen día, <b>".$resultado_registros[0][6]."</b><br></p>
                            <p>De manera atenta, le confirmamos que su solicitud de <b>Cancelación</b> de cita para atención presencial en <b>Prosperidad Social</b> ha sido registrada.</p>
                            
                          <p>Le recordamos que para agendar una nueva cita deberá ingresar en la siguiente página web: <a href='https://dps.iq-online.net.co/citas/inicio'>https://dps.iq-online.net.co/citas/inicio</a></p>
