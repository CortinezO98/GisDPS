<?php
    ...
    // Nombramos la hoja 0
    $spreadsheet->getActiveSheet()->setTitle('Reporte Gestión Citas FA');
    ...
    if ($tipo_reporte=='Consolidado Gestión') {
        ...
        $spreadsheet->getActiveSheet()->setCellValue('E4','Punto Atención');
        $spreadsheet->getActiveSheet()->setCellValue('F4','Dirección');
        $spreadsheet->getActiveSheet()->setCellValue('G4','Municipio');
        $spreadsheet->getActiveSheet()->setCellValue('H4','Departamento');
        $spreadsheet->getActiveSheet()->setCellValue('I4','Ciudadano-Tipo Documento');
        $spreadsheet->getActiveSheet()->setCellValue('J4','Ciudadano-Número Identificación');
        $spreadsheet->getActiveSheet()->setCellValue('K4','Ciudadano-Nombres y Apellidos');
        $spreadsheet->getActiveSheet()->setCellValue('L4','Ciudadano-Correo');
        $spreadsheet->getActiveSheet()->setCellValue('M4','Ciudadano-Celular');
        $spreadsheet->getActiveSheet()->setCellValue('N4','Ciudadano-Fijo');
        $spreadsheet->getActiveSheet()->setCellValue('O4','Ciudadano-Autoriza Políticas');
        $spreadsheet->getActiveSheet()->setCellValue('P4','Fecha Atención');
        $spreadsheet->getActiveSheet()->setCellValue('Q4','Radicado');
        $spreadsheet->getActiveSheet()->setCellValue('R4','Atención Preferencial');
        $spreadsheet->getActiveSheet()->setCellValue('S4','Información Poblacional');
        $spreadsheet->getActiveSheet()->setCellValue('T4','Observaciones');
        $spreadsheet->getActiveSheet()->setCellValue('U4','Fecha Cancelación');
        $spreadsheet->getActiveSheet()->setCellValue('V4','Fecha Registro');
        ...
        for ($i=5; $i < count($resultado_registros)+5; $i++) {
            ...
            $spreadsheet->getActiveSheet()->setCellValue('E'.$i,$resultado_registros[$i-5][15]);
            $spreadsheet->getActiveSheet()->setCellValue('F'.$i,$resultado_registros[$i-5][16]);
            $spreadsheet->getActiveSheet()->setCellValue('G'.$i,$resultado_registros[$i-5][24]);
            $spreadsheet->getActiveSheet()->setCellValue('H'.$i,$resultado_registros[$i-5][23]);
            $spreadsheet->getActiveSheet()->setCellValue('I'.$i,$resultado_registros[$i-5][4]);
            $spreadsheet->getActiveSheet()->setCellValue('J'.$i,$resultado_registros[$i-5][5]);
            $spreadsheet->getActiveSheet()->setCellValue('K'.$i,$resultado_registros[$i-5][6]);
            $spreadsheet->getActiveSheet()->setCellValue('L'.$i,$resultado_registros[$i-5][7]);
            $spreadsheet->getActiveSheet()->setCellValue('M'.$i,$resultado_registros[$i-5][8]);
            $spreadsheet->getActiveSheet()->setCellValue('N'.$i,$resultado_registros[$i-5][9]);
            $spreadsheet->getActiveSheet()->setCellValue('O'.$i,$resultado_registros[$i-5][10]);
            $spreadsheet->getActiveSheet()->setCellValue('P'.$i,$resultado_registros[$i-5][13]);
            $spreadsheet->getActiveSheet()->setCellValue('Q'.$i,$resultado_registros[$i-5][25]);
            $spreadsheet->getActiveSheet()->setCellValue('R'.$i,$resultado_registros[$i-5][26]);
            $spreadsheet->getActiveSheet()->setCellValue('S'.$i,$resultado_registros[$i-5][27]);
            $spreadsheet->getActiveSheet()->setCellValue('T'.$i,$resultado_registros[$i-5][11]);
            $spreadsheet->getActiveSheet()->setCellValue('U'.$i,$resultado_registros[$i-5][28]);
            $spreadsheet->getActiveSheet()->setCellValue('V'.$i,$resultado_registros[$i-5][14]);
        }
    }
