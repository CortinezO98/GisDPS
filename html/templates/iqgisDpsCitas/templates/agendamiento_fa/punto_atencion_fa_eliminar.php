<?php
  ...
  if(isset($_POST["guardar_registro"])){
    ...
    $consulta_actualizar = $enlace_db->prepare("UPDATE `gestion_citasfa_punto_atencion` SET `gcpa_regional`=?,`gcpa_municipio`=?,`gcpa_punto_atencion`=?,`gcpa_direccion`=?,`gcpa_estado`=? WHERE `gcpa_id`=?");
