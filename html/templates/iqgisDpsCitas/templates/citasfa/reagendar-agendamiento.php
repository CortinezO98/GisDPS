...
// ini_set('display_errors', '1');
    ...
    if (count($resultado_registros_reserva)>0) {
        ...
        $consulta_registros_departamento->bind_param("s", $resultado_registros_reserva[0][17]);
                ...
                <div class="col-lg-8 d-flex flex-column">
                  <div class="row flex-grow">
                    <div class="col-12 col-lg-12 grid-margin stretch-card">
                      <div class="card card-rounded">
                        <div class="card-body">
                            <div class="col-md-12 pb-4 fw-bold">Proceso de Reagendamiento</div>
                                        ...
                                        <?php if(isset($_POST["buscar_punto"]) AND count($resultado_registros_punto_atencion)>0): ?>
                                            ...
                                            <?php for ($i=0; $i < count($resultado_registros_punto_atencion); $i++): ?>
                                                <div class="col-md-6 enlace-punto">
                                                    <a href="reagendar-citas?t=<?php echo base64_encode($tipo); ?>&con=<?php echo base64_encode($id_consecutivo); ?>&idp=<?php echo base64_encode($resultado_registros_punto_atencion[$i][0]); ?>&confim=<?php echo base64_encode('token-citas'); ?>" class="">
