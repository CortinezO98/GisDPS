                                ...
                                <div class="col-md-12 py-2">
                                    ...
                                    <?php for ($i=0; $i < count($resultado_registros_botones); $i++): ?>
                                      <?php if($resultado_registros_botones[$i][3]=='Preguntas'): ?>
                                        <a href="datospersonales?t=<?php echo base64_encode('preguntas'); ?>&id=<?php echo base64_encode($resultado_registros_botones[$i][0]); ?>" class="btn btn-primary d-block mb-1"><?php echo $resultado_registros_botones[$i][2]; ?></a>
