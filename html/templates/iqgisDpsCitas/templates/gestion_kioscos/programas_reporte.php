...
<div class="modal fade" id="modal-reporte" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form name="reporte" action="programas_reporte_excel.php" method="POST">
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
              <div class="form-group">
                  <label for="tipo_reporte" class="m-0">Programa</label>
                  <select class="form-control form-control-sm form-select" name="tipo_reporte" id="tipo_reporte" required>
                      <option value="">Seleccione</option>
                      <option value="Todos">Todos</option>
                      <?php for ($i=0; $i < count($resultado_registros); $i++): ?>
                        <option value="<?php echo $resultado_registros[$i][0]; ?>"><?php echo $resultado_registros[$i][1]; ?></option>
                      <?php endfor; ?>
                  </select>
              </div>
          </div>
