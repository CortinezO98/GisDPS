<?php
  ...
  $array_contenidos = $_POST['miorden'];
    ...
    $consulta_actualizar = $enlace_db->prepare("UPDATE `gestion_kioscos_preguntas` SET `gkbp_orden`=? WHERE `gkbp_boton`=? AND `gkbp_id`=?");

    // Agrega variables a sentencia preparada
    $consulta_actualizar->bind_param('sss', $orden, $id_boton, $id_pregunta);
