...
<div class="modal fade" id="modal-reporte" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form name="reporte" action="atencion_scita_reporte_excel.php" method="POST">
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-12">
              <div class="form-group">
                  <label for="usuarios" class="m-0">Usuario</label>
                  <select class="selectpicker form-control form-control-sm form-select" name="usuarios[]" id="usuarios" multiple title="Usuario">
