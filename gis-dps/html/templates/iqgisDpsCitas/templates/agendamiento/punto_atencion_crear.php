<?php
  ...
  if(isset($_POST["guardar_registro"])){
      ...
      if($_SESSION[APP_SESSION.'_registro_creado_agendamiento_punto']!=1){
          ...
          $sentencia_insert = $enlace_db->prepare("INSERT INTO `gestion_citas_punto_atencion`(`gcpa_regional`, `gcpa_municipio`, `gcpa_punto_atencion`, `gcpa_direccion`, `gcpa_estado`, `gcpa_registro_usuario`) VALUES (?,?,?,?,?,?)");

          // Agrega variables a sentencia preparada
          $sentencia_insert->bind_param('ssssss', $regional, $ciudad, $punto_atencion, $direccion, $estado, $_SESSION[APP_SESSION.'_session_usu_id']);
