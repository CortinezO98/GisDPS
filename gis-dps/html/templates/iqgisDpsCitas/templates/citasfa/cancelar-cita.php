                                        ...
                                        <?php if (isset($_POST["buscar_cita"]) AND count($resultado_registros_reserva)>0 AND $citas_disponibles>0 AND $captcha_response): ?>
                                            <div class="card text-center">
                                              <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <a href="cancelar-cita-valida?t=<?php echo base64_encode('cancelar-confirma'); ?>&id=<?php echo base64_encode($resultado_registros_reserva[0][0]); ?>" class="btn btn-danger">Cancelar Cita</a>
